let open_talents = function(reload = false) {
    ...
    for (let i = 0; i<player.talents.length; i++) {
        ...
        for (let j = 0; j<player.talents[i].length; j++) {
            ...
            html+= "<div onclick='player.changeTalent("+i+","+j+")' class='"+classes+"'> <div class='window_talentButtonImg'><img src='"+iconsPath[talentName]+"'></div> <div class='window_talentName'><span>"+talentName+"</span></div> </div>"
        }
        html += "</div>"
    }
