...
let raiders = [
    new Raider("raider1",50500,100,50,50,0,"restodruid"),
    new Raider("raider2",50500,100,200,80,0,"assassination"),
    new Raider("raider3",50500,100,150,10,0,"restosham"),
    new Raider("raider4",50500,100,250,200,0,"restodruid"),
    new Raider("raider5",50500,100,200,200,0,"assassination"),
    new Raider("raider6",50500,100,150,200,0,"restosham"),
