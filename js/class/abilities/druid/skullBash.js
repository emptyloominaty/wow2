class SkullBash extends Ability {
    constructor() {
        let name = "Skull Bash"
        let cost = 0
        let gcd = 0
    ...
    getTooltip() {
        return "You charge and bash the target's skull, interrupting spellcasting and preventing any spell in that school from being cast for 4 sec."
    }
