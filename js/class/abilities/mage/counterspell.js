class Counterspell extends Ability {
    constructor() {
        let name = "Counterspell"
        let cost = 2
        let gcd = 0
        let castTime = 0
        let cd = 24
    ...
    getTooltip() {
        return "Counters the enemy's spellcast, preventing any spell from that school of magic from being cast for 6 sec."
    }
